...
public class MetricWeighingMachine {
    public static void main(String[] args) {
        ...
        // ImperialWeighingMachine - // Existing weighing machine is used to weigh the
        // baby in pounds
        ...
        WeighingMachineAdaptor weightMachineAdaptor = new WeighingMachineAdaptorImpl(imperialWeighingMachine);
