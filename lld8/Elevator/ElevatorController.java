...
public class ElevatorController implements Runnable {
    ...
    private void enqueueRequest(int destinationFloor) {
        System.out.println("Request details -> destinationFloor: " + destinationFloor + " accepted by elevator: "
                + elevatorCar.id);
        ...
        synchronized (monitor) {
            monitor.notify(); // wake up elevator thread
        }
    }
    ...
    public void controlElevator() {
        while (true) {
            ...
            while (!upMinPQ.isEmpty()) {
                ...
                System.out.println("Serving floor: " + floor + " by elevator: " + elevatorCar.id + " currentFloor: "
